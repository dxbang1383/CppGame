...
#include "../GameObject/Tile/teleport.h"
...
public:
    ...
    void addTeleport(int col, int row, int groupId);
    // Tra ve teleport cung nhom nhung khac vi tri, nullptr neu khong co
    teleport* findPartner(const teleport& from);
